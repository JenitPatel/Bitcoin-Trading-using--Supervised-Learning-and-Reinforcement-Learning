...
class CustomEnv:
    ...
    def __init__(self, df, initial_balance=1000, lookback_window_size=50):
        ...
        # Market history contains the OHCL values for the last lookback_window_`size prices
...
df = pd.read_csv('C:\\Users\\Jenit\\Desktop\\pricedata.csv')
...
Random_games(train_env, train_episodes=10, training_batch_size=500) # input to bitcoin agent